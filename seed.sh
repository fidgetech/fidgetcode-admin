...
npm run createtrack -- --emulator=$USE_EMULATOR --syllabus='v1'
npm run createtrack -- --emulator=$USE_EMULATOR --syllabus='v2'
npm run assigntrack -- --emulator=$USE_EMULATOR --email='student1@fidgetech.org' --track='v1'
npm run assigntrack -- --emulator=$USE_EMULATOR --email='student2@fidgetech.org' --track='v2'
